...
export const NotifyValidationMessage = {
  ...
  MailHostInvalidFormat: 'Mail host should be a string value.',
  MailPasswordRequired: 'Mail password is required',
  MailPasswordInvalidFormat: 'Mail password should be a string value.',
  MailPortNumber: 'Mail port should be a number between 0 and 655535.',
  MailUserRequired: 'Mail user is required',
  MailUserInvalidFormat: 'Mail user should be a string value.',
  MailFromRequired: 'Mail queue is required',
  MailFromInvalidFormat: 'Mail queue should be a string value.',
} as const;
